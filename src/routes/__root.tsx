...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Zuridoc" },
      { name: "description", content: "Create professional business documents with your logo, colors, and company details." },
      { name: "author", content: "Zuridoc" },
      { property: "og:title", content: "Zuridoc" },
      { property: "og:description", content: "Create professional business documents with your logo, colors, and company details." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Zuridoc" },
      { name: "twitter:title", content: "Zuridoc" },
      { name: "twitter:description", content: "Create professional business documents with your logo, colors, and company details." },
